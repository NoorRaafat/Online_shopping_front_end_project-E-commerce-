...
<body>
    <form id="login" action="/login" method="POST" class="loge-in">
        <div class="LLOGO"></div>
        <div class="LLlogin">Login</div>
        <div class="fileds">
            <div class="username"> <i class="fas fa-user"></i>
                <input type="text" name="username" id="name" class="user-input" placeholder=" Username">
            </div>
